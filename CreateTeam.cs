...
namespace BackaBarnet
{
    class CreateTeam
    {
        ...
        Run([HttpTrigger(AuthorizationLevel.Function, "post", Route = "team/create")] HttpRequest req, ILogger log)
        {
            ...
            try
            {
                ...
                {
                    connection.Open();
                    var query = @"exec bb.usp_CreateTeam '" + body.TeamName + "', " + body.UnitID;
