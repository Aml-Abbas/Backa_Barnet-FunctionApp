...
namespace BackaBarnet
{
    class CreateEvent
    {
        ...
        Run([HttpTrigger(AuthorizationLevel.Function, "post", Route = "event/create")] HttpRequest req, ILogger log)
        {
            ...
            try
            {
                ...
                {
                    connection.Open();
                    var query = @"exec bb.usp_CreateEvent " + body.PersonID + ", '" + body.Action + "', '" + body.Event + "', '" + body.Responsible + "', '" + body.Profession + "'";
