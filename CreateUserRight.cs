...
namespace BackaBarnet
{
    ...
    {
        [FunctionName("CreateUserRight")]
        public static async Task<IActionResult>
        Run([HttpTrigger(AuthorizationLevel.Function, "post", Route = "user/create/right")] HttpRequest req, ILogger log)
        {
            ...
            try
            {
                ...
                {
                    connection.Open();
                    var query = @"exec bb.usp_CreateUserRight " + userRight.CurrentUserID + ", " +  userRight.UserID + ", " + userRight.PersonID + ", " + userRight.Type;
