...
namespace BackaBarnet
{
    class EditSubstrate
    {
        [FunctionName("EditSubstrate")]
        public static async Task<IActionResult>
        Run([HttpTrigger(AuthorizationLevel.Function, "post", Route = "substrate/edit")] HttpRequest req, ILogger log)
        {
