...
namespace BackaBarnet
{
    class CreateAction
    {
        ...
        Run([HttpTrigger(AuthorizationLevel.Function, "post", Route = "action/create")] HttpRequest req, ILogger log)
        {
            ...
            try
            {
                ...
                {
                    connection.Open();
                    var query = @"exec bb.usp_CreateAction " + body.PersonID + ", '" + body.Action + "', " + body.EventID + ", '" + body.Responsible + "', '" + body.Profession + "'";
