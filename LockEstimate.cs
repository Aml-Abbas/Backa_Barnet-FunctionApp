...
namespace BackaBarnet
{
    class LockEstimate
    {
        [FunctionName("LockEstimate")]
        public static async Task<IActionResult>
        Run([HttpTrigger(AuthorizationLevel.Function, "post", Route = "estimate/lock")] HttpRequest req, ILogger log)
        {
            ...
            try
            {
                ...
                {
                    connection.Open();
                    var query = @"exec bb.usp_LockEstimate " + body.PersonID + ", " + body.UserID + ", '" + body.GradedOn + "'";
