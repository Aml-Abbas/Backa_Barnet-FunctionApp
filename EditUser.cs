...
namespace BackaBarnet
{
    class EditUser
    {
        ...
        Run([HttpTrigger(AuthorizationLevel.Function, "post", Route = "user/edit")] HttpRequest req, ILogger log)
        {
            ...
            try
            {
                ...
                {
                    connection.Open();
                    var query = @"exec bb.usp_EditUser '" + body.LastName + "', '" + body.FirstName + "', '" + body.Organisation + "', " + body.RoleID + ", " + body.UnitID + ", " + body.UserID;
