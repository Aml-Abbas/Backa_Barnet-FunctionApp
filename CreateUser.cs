...
namespace BackaBarnet
{
    class CreateUser
    {
        ...
        Run([HttpTrigger(AuthorizationLevel.Function, "post", Route = "user/create")] HttpRequest req, ILogger log)
        {
            ...
            try
            {
                ...
                {
                    connection.Open();
                    var query = @"exec bb.usp_CreateUser '" + body.LastName + "', '" + body.FirstName + "', '" + body.Email + "', '" + body.Organisation + "', " + body.RoleID + ", " + body.UnitID;
