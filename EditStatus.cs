...
namespace BackaBarnet
{
    class EditStatus
    {
        ...
        Run([HttpTrigger(AuthorizationLevel.Function, "post", Route = "status/edit")] HttpRequest req, ILogger log)
        {
            ...
            try
            {
                ...
                {
                    connection.Open();
                    var query = @"exec bb.usp_EditStatus " + body.PersonID + ", " + body.StatusID;
